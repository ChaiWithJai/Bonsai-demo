# Price a bond from a worksheet in Bonsai

Turn a worksheet into confirmed bond inputs, inspect the payment schedule, and measure the effect of a yield change in New chat.

Repository: [ChaiWithJai/Bonsai-demo](https://github.com/ChaiWithJai/Bonsai-demo). Source revision: `bf425c5`. Companion cut: `01-bond-pricing-FINAL.mp4`, 70.6 seconds. Recorded September 23, 2026.
