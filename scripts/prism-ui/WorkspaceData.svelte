...
<section class="data" aria-label="Desktop sources">
  ...
  <p class="fine">Up to 20 files, 25 MiB each. Tables, text, email exports, and PDF pages are extracted locally. PDF pages without embedded text use OCR on this Mac. Images use local OCR. Visual interpretation, audio, and video workflows are still being connected.</p>
