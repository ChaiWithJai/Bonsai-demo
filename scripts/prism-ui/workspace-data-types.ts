...
export type SourceSummary = { source_id: string; filename: string; sha256: string; kind: string; status: string; record_count: number; extraction_error?: string; extraction_run_url?: string; extraction_coverage?: {page_count:number; pages_with_text:number; unresolved_pages:number[]; ocr_pages:number[]; limitation:string} };
