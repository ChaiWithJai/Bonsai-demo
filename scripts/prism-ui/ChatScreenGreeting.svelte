<script lang="ts">
  ...
  const features = [{"title": "Bond math", "detail": "Bring your working. Explore the cash flows.", "prompt": "Help me work through bond math from my notes or a whiteboard image. First show the variables, units, and missing assumptions for my confirmation. We can compare Treasury context across mayoral eras and work through one exercise at a time.", "tool": true}, {"title": "Document review", "detail": "Compare financial or legal evidence.", "prompt": "Help me review the financial or legal documents I attach. First ask which review I need. Compare the claims against the source passages, preserve dates, units and exceptions, and show unresolved questions. Ask for my review before drawing a conclusion. Use jev_evidence_check only when I explicitly request a cloud check. Keep the evidence and review in this conversation.", "tool": true}];
